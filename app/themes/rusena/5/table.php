				...
				<div class="row">
					...
					<div class="col-md-6">
						<div id="cart-block" class="form-block">
							...
							<span class="label">ТОВАРОВ В КОРЗИНЕ:</span><span class="value">0</span>
							<span class="label">НА СУММУ:</span><span class="value">0 Р</span>
							<div class="actions">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-3">
					<div class="aside-block">
						<div id="aut-form">
							...
							<form>
								...
								<div class="form-element">
									<input name="login" type="password" placeholder="Пароль"/>
								</div>
								<div class="links">
					...
					<div class="aside-block">
						<a class="title news-title" href="#">Новости</a>
						<div class="news-block">
							<div class="news">
								<div class="date">11.05.2015</div>
								<a href="#" class="title">Обновление каталога продукции 2015</a>
								<div class="text">
